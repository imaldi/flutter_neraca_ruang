...
class _RoundedContainerState extends State<RoundedContainer> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: widget.padding ?? const EdgeInsets.all(normal),
      margin: widget.margin ?? const EdgeInsets.symmetric(vertical: normal),
      constraints: widget.constraints ?? const BoxConstraints(minHeight: big),
